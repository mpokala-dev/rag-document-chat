This is a [Next.js](https://nextjs.org) project bootstrapped with [`create-next-app`](https://nextjs.org/docs/app/api-reference/cli/create-next-app).![CI](https://github.com/mpokala-dev/rag-document-chat/actions/workflows/ci.yml/badge.svg)
